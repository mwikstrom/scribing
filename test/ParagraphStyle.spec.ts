...
describe("ParagraphStyle", () => {
    it("can be extended", () => {
        ...
        const extended = original.merge({alignment: "center", type: "h1"});
        expect(extended.equals({alignment: "center", direction: "ltr", type: "h1"})).toBe(true);
    });

    it("can be reduced", () => {
        const original = new ParagraphStyle({alignment: "center", direction: "ltr", line_spacing: 100});
        const reduced = original.unmerge({alignment: "end", direction: "ltr", type: "h1"});
    ...
    it("can be reduced by keys only", () => {
        ...
        const reduced = original.unset("alignment", "type");
