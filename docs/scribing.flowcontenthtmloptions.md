...
|  [getImageUrl?](./scribing.flowcontenthtmloptions.getimageurl.md) |  | (this: void, source: [ImageSource](./scribing.imagesource.md)<!-- -->, scale: number, usage: [ImageUsage](./scribing.imageusage.md)<!-- -->) =&gt; string \| Promise&lt;string&gt; | _(Optional)_ |
