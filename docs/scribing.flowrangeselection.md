...
|  [formatParagraph(style)](./scribing.flowrangeselection.formatparagraph.md) |  | Creates an operation that applies the specified paragraph style on the current selection |
