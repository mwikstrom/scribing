...
|  --- | --- | --- |
|  [afterInsertion(other)](./scribing.insertcontent.afterinsertion.md) |  | Transforms the current operation so that its intent is preserved after the specified range was inserted. |
...
|  [applyToContent(content, scope)](./scribing.insertcontent.applytocontent.md) |  | Applies the current operation on the specified content and returns the updated result. |
